...
**There La Quinta's outside of the US in Canada, Mexico, Honduras, Colombia, Turkey, and Chile. There are no Denny's outside the US**:
...
**We could use the filter function for the names variable in the states data**:
...
**This is a little strange because you would assume states with the fewest would be the same**:
